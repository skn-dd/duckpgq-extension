...
// Constructor
PersonalizedPageRankFunctionData::PersonalizedPageRankFunctionData(ClientContext &ctx, int32_t csr)
...
PersonalizedPageRankFunctionData::PersonalizedPageRankBind(ClientContext &context, ScalarFunction &bound_function,
	...
	return make_uniq<PersonalizedPageRankFunctionData>(context, csr_id);
}

// Copy method
unique_ptr<FunctionData> PersonalizedPageRankFunctionData::Copy() const {
	auto result = make_uniq<PersonalizedPageRankFunctionData>(context, csr_id);
...
// Equals method
bool PersonalizedPageRankFunctionData::Equals(const FunctionData &other_p) const {
	auto &other = other_p.Cast<PersonalizedPageRankFunctionData>();
