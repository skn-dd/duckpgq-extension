...
// Constructor
ArticleRankFunctionData::ArticleRankFunctionData(ClientContext &ctx, int32_t csr)
...
unique_ptr<FunctionData> ArticleRankFunctionData::ArticleRankBind(ClientContext &context,
	...
	return make_uniq<ArticleRankFunctionData>(context, csr_id);
}

// Copy method
unique_ptr<FunctionData> ArticleRankFunctionData::Copy() const {
	auto result = make_uniq<ArticleRankFunctionData>(context, csr_id);
...
// Equals method
bool ArticleRankFunctionData::Equals(const FunctionData &other_p) const {
	auto &other = other_p.Cast<ArticleRankFunctionData>();
