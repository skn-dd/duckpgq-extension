#include "duckpgq/core/functions/table/out_degree_centrality.hpp"
...
unique_ptr<TableRef> OutDegreeCentralityFunction::OutDegreeCentralityBindReplace(ClientContext &context,
	...
	auto select_node = CreateSelectNode(edge_pg_entry, "out_degree_centrality", "out_degree_centrality");
	...
	result->alias = "out_degree_centrality";
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterOutDegreeCentralityTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(OutDegreeCentralityFunction());
}
