...
unique_ptr<TableRef> LabelPropagationFunction::LabelPropagationBindReplace(ClientContext &context,
	...
	auto select_node = CreateSelectNode(edge_pg_entry, "label_propagation", "label");
	...
	result->alias = "label_propagation";
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterLabelPropagationTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(LabelPropagationFunction());
}
