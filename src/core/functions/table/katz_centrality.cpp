...
unique_ptr<TableRef>
KatzCentralityFunction::KatzCentralityBindReplace(ClientContext &context, TableFunctionBindInput &input) {
	...
	auto select_node = CreateSelectNode(edge_pg_entry, "katz_centrality", "katz_centrality");
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterKatzCentralityTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(KatzCentralityFunction());
}
