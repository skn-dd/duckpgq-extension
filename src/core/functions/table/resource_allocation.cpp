#include "duckpgq/core/functions/table/resource_allocation.hpp"
...
unique_ptr<TableRef> ResourceAllocationFunction::ResourceAllocationBindReplace(ClientContext &context,
                                                                              TableFunctionBindInput &input) {
	// resource_allocation(vertex_table, vertex_id_col, edge_table, src_col, dst_col) —
	...
	auto select_node = CreatePairwiseSelectNode(edge_pg_entry, "resource_allocation", "resource_allocation");
	...
	result->alias = "resource_allocation";
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterResourceAllocationTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(ResourceAllocationFunction());
}
