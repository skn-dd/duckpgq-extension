#include "duckpgq/core/functions/table/degree_centrality.hpp"
...
unique_ptr<TableRef> DegreeCentralityFunction::DegreeCentralityBindReplace(ClientContext &context,
	...
	auto select_node = CreateSelectNode(edge_pg_entry, "degree_centrality", "degree_centrality");
	...
	result->alias = "degree_centrality";
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterDegreeCentralityTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(DegreeCentralityFunction());
}
