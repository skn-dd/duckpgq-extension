#include "duckpgq/core/functions/table/louvain.hpp"
...
unique_ptr<TableRef> LouvainFunction::LouvainBindReplace(ClientContext &context, TableFunctionBindInput &input) {
	...
	auto select_node = CreateSelectNode(edge_pg_entry, "louvain", "community");
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterLouvainTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(LouvainFunction());
}
