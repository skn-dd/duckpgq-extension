#include "duckpgq/core/functions/table/preferential_attachment.hpp"
...
unique_ptr<TableRef> PreferentialAttachmentFunction::PreferentialAttachmentBindReplace(ClientContext &context,
	...
	auto select_node = CreatePairwiseSelectNode(edge_pg_entry, "preferential_attachment", "preferential_attachment");
	...
	result->alias = "preferential_attachment";
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterPreferentialAttachmentTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(PreferentialAttachmentFunction());
}
