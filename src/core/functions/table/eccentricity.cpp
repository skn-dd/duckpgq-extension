#include "duckpgq/core/functions/table/eccentricity.hpp"
...
unique_ptr<TableRef> EccentricityFunction::EccentricityBindReplace(ClientContext &context,
	...
	auto select_node = CreateSelectNode(edge_pg_entry, "eccentricity", "eccentricity");
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterEccentricityTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(EccentricityFunction());
}
