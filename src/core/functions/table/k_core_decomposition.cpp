...
unique_ptr<TableRef> KCoreDecompositionFunction::KCoreDecompositionBindReplace(ClientContext &context,
	...
	auto select_node = CreateSelectNode(edge_pg_entry, "k_core_decomposition", "core");
	...
	result->alias = "k_core_decomposition";
...
// Register functions
//------------------------------------------------------------------------------
void CoreTableFunctions::RegisterKCoreDecompositionTableFunction(ExtensionLoader &loader) {
	loader.RegisterFunction(KCoreDecompositionFunction());
}
